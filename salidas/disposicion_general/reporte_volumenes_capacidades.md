...
Fuente JSON: `resumen_disposicion_actualizado.json`
...
- Combustible requerido (con márgenes): 70.58823529411765 m3
- Cobertura tanques vs requerido: 1537.1818251011007%

## Observaciones

- Verificar que LDc y BDc coincidan con la extensión real del doble casco (entre mamparos).
- Ajustar B_interior con medición directa del modelo Maxsurf (Offets) para precisión.
- Recalcular VDc si DDF varía fuera de cámara de máquinas.
- Validar compatibilidad de VCM con espacio real en modelo 3D.
- Si cobertura combustible >> 100%, optimizar distribución o reducir volumen de algunos tanques.

## Próximos pasos

1. Exportar offsets desde Maxsurf (Automation) para reemplazar aproximaciones de volumen.
